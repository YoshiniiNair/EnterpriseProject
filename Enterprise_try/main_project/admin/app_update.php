        ...
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">
                ...
                <div>
                  <button type="submit" id="btn_approve" name="btn_approve" class="btn_approve btn btn-primary">
                    Approve
                  </button>
                  &nbsp
...
if(isset($_POST['btn_approve'])){
  ...
  $app_id = $_POST['app_id'];
  $sql = "UPDATE member_application SET app_status='Active' WHERE app_id='$app_id'";
